    ...
    <main className="container px-4 py-4">
      <div className="row">
        <aside className="col-md-3">
          <nav className="sticky-top pt-3" aria-label="Зміст сторінки">
            ...
            <ul className="nav flex-column">
              ...
              <a href="#introducedList" className="nav-link" data-bs-toggle="collapse">Інтродуковані в</a> {/* Повернуто */}
        ...
        <article className="col-md-9">
          <h2 className="h2 text-success mb-4">Ареал поширення їжаків</h2>
          ...
          <section id="continents" className="mt-4">
            ...
            <div className="collapse" id="continentsList">
              <ul className="list-group mb-3">
                ...
                <li className="list-group-item">Азія (деякі регіони)</li>
                <li className="list-group-item">Африка (переважно Північна)</li>
              </ul>
            </div>
          </section>
          ...
          <section id="subcontinents" className="mt-4">
            ...
            <div className="collapse" id="subcontinentsList">
              <ul className="list-group mb-3">
                ...
                <li className="list-group-item">Південна Європа</li>
                <li className="list-group-item">Східна Європа</li>
                <li className="list-group-item">Північна Африка</li>
                <li className="list-group-item">Близький Схід</li>
              </ul>
            </div>
          </section>
          ...
          <section id="countries" className="mt-4">
            ...
            <div className="collapse" id="countriesList">
              <ul className="list-group mb-3 list-columns">
                ...
                <li className="list-group-item">Росія (європейська частина)</li>
                ...
                <li className="list-group-item">Північна Африка (Марокко, Алжир, Туніс, Лівія, Єгипет)</li>
          ...
          <section id="biogeographic" className="mt-4">
            ...
            <div className="collapse" id="biogeographicList">
              <ul className="list-group mb-3">
                ...
                <li className="list-group-item">Афротропіка (північна частина)</li>
              </ul>
            </div>
          </section>
          ...
          <section id="biomes" className="mt-4">
            ...
            <div className="collapse" id="biomesList">
              <ul className="list-group">
                <li className="list-group-item">Помірні широколисті та змішані ліси</li>
                <li className="list-group-item">Помірні хвойні ліси</li>
                <li className="list-group-item">Середземноморські ліси, рідколісся та чагарники</li>
                <li className="list-group-item">Помірні луки, савани та чагарники</li>
              </ul>
            </div>
          </section>
        </article>
